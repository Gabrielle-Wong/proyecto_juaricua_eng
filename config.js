   ...
   // Story Details
    ...
    chapters: [
...

        {
            ...
            // image: './images/tulum_beach.jpg',
            description: 'This period also marks a shift in the short term rental business model, as we also begin to observe an increase in Airbnb hosts that manage multiple units - <strong>anywhere from dozens up to hundreds of units</strong>. These ‘multi-unit’ hosts have been the primary drivers of increases in listings in Mexico City. Between April 2019 and September 2024, while the number of listings from single-unit hosts decreased from 9,749 to 8,440, the number of listings from multi-unit hosts ballooned 67% from 10,819 to 18,142. <br> <br> The maps below illustrate the increase in the number of Airbnb units between 2019 and 2023, and in particular how these units are increasingly owned by large corporate hosts: mega-hosts. ',
...

        {
            ...
            // image: './images/tulum_beach.jpg',
            description: 'Colonia Juárez is one such neighborhood where Airbnb rentals have skyrocketed over the past few years. While there were only 612 Airbnb units in the neighborhood in 2019, as of June 2024, there are 1,200 units. This means that in five short years, there are effectively 600 fewer apartments that are no longer available as long term rentals: <strong>600 families have been pushed out of their homes to make way for these Airbnbs</strong>.',
...

        {
            ...
            description: 'Dinamarca 77 is one building in  Colonia Juárez where the effects of the capitalist real estate market are evident. 12 families are estimated to have been forcefully evicted in April 2018.  This building opened as 11 Airbnb units in October 2023. They are owned by Mr.W, the mega-host that manages the second-largest number of units in Mexico City. <br> <br>Mr. W was established in 2017 by brothers Luís Carlos Weber Zetina and Carlos Enrique Weber Zetina. Until 2019, their presence in Cuauhtémoc was relatively small (< 50 units), but they have since grown to host over 350 units in Cuauhtémoc. The company does not directly own these units. Rather, they are property managers that serve as an intermediary between property owners and potential guests, handling advertising and guest communication in exchange for a portion of the rental income. A spokesperson for the company estimates Airbnb could earn a landlord 30-40% more income from their unit compared to traditional rentals [3]. This is a clear incentive for landlords to evict families and turn the keys over to managers like Mr. W. ',
...

        {
            ...
            description:'<strong>As these maps and personal testimonies illustrate, Airbnb has had a tremendous impact on the daily lives of Mexico City residents in the city’s central core</strong>. In the case of Airbnb redevelopments like Dinamarca 77 and Pandora, tenants\' lives are upended, first through the trauma of the violent evictions they were forced to experience, and then by the difficulty residents often have in finding housing in their budget in the neighborhood. <br> <br> Available data [4] on average rents in Colonia Juárez show that rent increased at a faster rate compared to Mexico City as a whole, particularly during the period Airbnb listings were rapidly being added to the market. We observe this especially in 2022 as global tourism ‘bounced back’ following international travel restrictions of the COVID-19 era. This increase could be due in part to Airbnb taking housing off the local market and turning them into short-term rentals with inflated nightly costs. <strong>This graph also reveals how it is important to look to the neighborhood scale to determine Airbnb’s impact on rental prices - Mexico City is too vast to use city-wide rental data to reflect Airbnb’s impact</strong>. Other neighbourhoods with high numbers of Airbnb listings show similar patterns. ',
...

        {
            ...
            imageCaption: 'Murals like these on Turin 46 are one way organizers in la Colonia Juárez resist blanqueamiento por despojo and make their claims to the neighbourhood visible.',
            // image: './images/tulum_beach.jpg',
...

        {
            ...
            description: "Proyecto Juaricua is a collaboration between Mexican, Canadian and American researchers and organizers. <br> <br> <strong> <em> This research was supported by a collaboration with the <a href=\"https://antievictionmap.com\" style=\"color:#ffffff;\" target=\"_blank\">Anti-Eviction Mapping Project</a> and data from  <a href=\"https://insideairbnb.com/about/\" style=\"color:#ffffff;\" target=\"_blank\">Inside Airbnb</a>.",
            location: {
